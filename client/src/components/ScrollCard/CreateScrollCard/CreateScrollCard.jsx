...
<Modal isOpen={isOpen} onClose={onClose}>
  ...
  <ModalContent>
    ...
    <ModalBody>
      <Stack spacing={5}>    
    <Input  _focus={{   boxShadow:"0 0 0px 0px rgba(88, 144, 255, 0), 0 1px 1px rgba(0, 0, 0, 0)"}} placeholder="SCROLL Title" />
    <Input  _focus={{   boxShadow:"0 0 0px 0px rgba(88, 144, 255, 0), 0 1px 1px rgba(0, 0, 0, 0)"}} placeholder="VIDEO LINK" />
      </Stack>
   </ModalBody>
